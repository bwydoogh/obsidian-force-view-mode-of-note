import { WorkspaceLeaf, Plugin, MarkdownView, App, TFile, PluginSettingTab, Setting, EventRef, debounce } from 'obsidian';
...
export default class ViewModeByFrontmatterPlugin extends Plugin {
	...
	async onload() {
		...
		this.registerEvent(this.app.workspace.on("active-leaf-change", debounce(readViewModeFromFrontmatterAndToggle, 100)));
	}
